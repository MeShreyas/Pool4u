 ...
 *
 */
public class AnswerPoolQueryHandler implements ActionHandler {
	...
	public String execute(HttpServletRequest request,
		...
		try{
			poolQueryService.respondPoolQuery(poolQuery);
	...
	private void setUIDataToVO(HttpServletRequest request, HttpSession session)  {
		...
		tempStr = request.getParameter("response");
