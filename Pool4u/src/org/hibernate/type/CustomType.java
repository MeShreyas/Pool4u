...
import org.hibernate.usertype.LoggableUserType;
  ...
  public class CustomType extends AbstractType implements IdentifierType, DiscriminatorType, VersionType {
  	...
  	public CustomType(Class userTypeClass, Properties parameters) throws MappingException {
  		...
  		while (it.hasNext()) {
  			str = (String)it.next();
			System.out.println(str +" : "+parameters.getProperty(str));
		}
  	...
  	public CustomType(org.hibernate.usertype.UserType userTypeClass, String parameters) throws MappingException {
  		this(userTypeClass.getClass(),new Properties());
  	}
