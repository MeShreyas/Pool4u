...
function initMap() {
	...
	mapTo = new google.maps.Map(document.getElementById("map_to_post"), myOptions);
	mapFrom = new google.maps.Map(document.getElementById("map_from_post"), myOptions);
	...
	document.getElementById("map_from_post_latlng").value = latlng.toString();
	document.getElementById("map_to_post_latlng").value = latlng.toString();
}
...
function placeMarkerFrom(location) {
	...
	document.getElementById("map_from_post_latlng").value = location.toString();
}
...
function placeMarkerTo(location) {
	...
	document.getElementById("map_to_post_latlng").value = location.toString();
}
