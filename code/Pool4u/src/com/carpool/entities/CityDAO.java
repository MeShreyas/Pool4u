...
public class CityDAO implements ICityDAO {
	...
	public void save(City entity) {
		EntityManagerHelper.log("saving City instance", Level.INFO, null);
		try {
	...
	public void delete(City entity) {
		EntityManagerHelper.log("deleting City instance", Level.INFO, null);
		try {
			entity = getEntityManager().getReference(City.class,
					entity.getCityId());
	...
	public City update(City entity) {
		EntityManagerHelper.log("updating City instance", Level.INFO, null);
		try {
	...
	public City findById(Integer id) {
		EntityManagerHelper.log("finding City instance with id: " + id,
				Level.INFO, null);
		try {
	...
	public List<City> findByProperty(String propertyName, final Object value,
			final int... rowStartIdxAndCount) {
		EntityManagerHelper.log("finding City instance with property: "
				+ propertyName + ", value: " + value, Level.INFO, null);
		try {
			final String queryString = "select model from City model where model."
	...
	public List<City> findByCityName(Object cityName,
		...
		return findByProperty(CITY_NAME, cityName, rowStartIdxAndCount);
	}
	...
	public List<City> findAll(final int... rowStartIdxAndCount) {
		EntityManagerHelper.log("finding all City instances", Level.INFO, null);
		try {
			final String queryString = "select model from City model";
			Query query = getEntityManager().createQuery(queryString);
			if (rowStartIdxAndCount != null && rowStartIdxAndCount.length > 0) {
				int rowStartIdx = Math.max(0, rowStartIdxAndCount[0]);
				if (rowStartIdx > 0) {
